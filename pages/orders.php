...
<a href="<?php _e(PDCKL_ADMIN_LINK); ?>&s=orders&a=backup_restore" style="float:right;"><input type="button" class="button action" value="<?php echo $pdckl_lang['btn_restore_backup']; ?>"></a>
...
<form name="pdckl_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
    <table class="wp-list-table widefat" style="margin-top:10px;">
        <thead>
            <tr>
                <td colspan="3"><h3><?php echo $pdckl_lang['orders_edit_title']; ?></h3></td>
            </tr>
        </thead>
        <tbody>
          <tr>
         ...
         <tr>
            ...
            <td colspan="2"><input type="submit" name="Submit" value="<?php echo $pdckl_lang['btn_save']; ?>" class="button-primary" /></td>
            <td style="text-align:right;"><a href="<?php _e(PDCKL_ADMIN_LINK); ?>&s=orders"><input type="button" class="button action" name="Back" value="<?php echo $pdckl_lang['btn_close']; ?>"></a></td>
         </tr>
        </tbody>
    </table>                 
</form>
...
<table class="wp-list-table widefat" style="margin-top:10px;">
    <thead style="font-weight:bold;">
        <tr>
            <td><?php echo $pdckl_lang['orders_table_ido']; ?></td>
            <td><?php echo $pdckl_lang['orders_table_idp']; ?></td>
            <td><?php echo $pdckl_lang['orders_table_date']; ?></td>
            <td><?php echo $pdckl_lang['orders_table_link']; ?></td>
            <td><?php echo $pdckl_lang['orders_table_tools']; ?></td>
        </tr>
    </thead>
    <tbody>
        <?php 
