...
$pdckl_lang = array(
    ...
    <ol>
      ...
      <li>
        Pokud nemáte účet na Copywriting.cz, založte si jej a pak v <b>Reklamní prostor (nahoře v menu) -> Nabízím reklamu -> Moje weby -> Přidat web</b>
      </li>
      <li>
        Po schválení webu (většinou do 24h) v <b>Reklamní prostor (nahoře v menu) -> Nabízím reklamu -> Moje weby -> <em>tento web</em> -> Nastavit podčlánkovou inzerci</b>
      </li>
    </ol>',
    ...
    'main_menu_settings'        => 'Rozšířené nastavení',
    'main_menu_start'           => 'Prvotní nastavení',
    ...
    'settings_version_old'      => array('Používáte zastaralou verzi pluginu!',
                                         'Aktuální verze:',
                                         'Stáhnout',
    ...
    'settings_tables_error'     => array('Nenalezeno! Plugin nelze aktivovat!',
    ...
    'settings_plugin_enable'    => array('Povolit plugin:',
                                        'Ano',
                                        'Ne'),
    'settings_plugin_purchase'  => array('Povolit nákup reklamy:',
                                         'Ano',
                                         'Ne'),
    ...
    'settings_paypal_desc' => 'Návod na nastavení PayPalu krok po kroku si <a href="http://www.copywriting.cz/napoveda/7" target="_blank">stáhněte zdarma zde</a>.',
    ...
    'settings_copywriting_desc' => 'Zde můžete propojit plugin s Vašim <a href="http://www.copywriting.cz" target="_blank">Copywriting účtem</a>',
    ...
    'orders_table_ido'          => 'ID objednávky',
    ...
    'n_settings_update_error'   => array('Cena za článek musí být větší než 0',
    ...
    'n_orders_backup_created'   => array('Soubor se zálohou byl úspěšně vytvořen',
                                         'Stáhnout soubor'),
    'n_orders_backup_error'     => 'Soubor se zálohou se nepodařilo vytvořit',
    'n_orders_backup_restore'   => 'Při nahrání zálohy se odstraní všechny aktuální objednávky',
    'n_orders_backup_up_error'  => array('Nebyl vybrán žádný soubor k nahrání',
                                         'Soubor se zálohou musí mít koncovku .xml',
                                         'Soubor se zálohou se nepodařilo nahrát',
                                         'Soubor se zálohou je prázdný, nebo jsou data ve špatném formátu'),
    'n_orders_backup_loaded'    => 'Záloha byla úspěšně iportována do systému',
    ...
    'h_settings_purchase'       => 'Určuje, zda je možné na webu zakoupit reklamu. <br>
    ...
    'h_settings_jquery'         => 'Povolí/Zakáže načtení jQuery knihovny z http://ajax.googleapis.com/ajax/libs/jquery/ <br>
    ...
    'h_settings_max_links'      => 'Určuje, kolik lze pod každým článkem koupit maximálně odkazů. <br> 
                                    V případě, že je dosažen nastavený počet, pod daným článkem již nelze zakoupit další reklamu',
    'h_settings_link_price'     => '- částka musí být vyšší než 0 <br> 
                                    - uvedená částka <u>zahrnuje 10Kč poplatek</u> za transakci <br>',
    'h_settings_link_price_ext' => 'Pokud je článek starší než zadaný počet dnů, změní se jeho cena na zde zadanou. <br>
                                    Pokud chcete cenu článku vždy stejnou, zadejte do pole pro extra cenu 0',                                    
    'h_settings_copywriting'    => 'Token pro propojení pluginu s Vaším Copywriting účtem si můžete vygenerovat zde:<br><b>Copywriting.cz -> Reklamní prostor -> Nabízím reklamu -> Moje weby -> <i>váš web</i> -> Nastavení podčlánkové inzerce</b>',                                  
    'h_add_link_clid'           => 'Zadejte ID článku, pod který chcete reklamu přidat',
    'h_add_link_link'           => 'Zadejte URL odkazu - VČETNĚ http://',
